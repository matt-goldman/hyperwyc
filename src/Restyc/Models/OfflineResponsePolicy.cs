...
/// <summary>
/// Controls the HTTP status code returned to callers when Restyc handles a
...
/// <c>X-Restyc-Status</c> header always indicates the true state
...
public enum OfflineResponsePolicy
{
    ...
    /// <c>X-Restyc-Status</c> header if needed. This is the default.
    /// </summary>
    Transparent,
