...
| **19** | [Sample — .NET MAUI app](Done/19-poc-maui-app.md) | 🟡 Partial | **Core scenario proven on device:** catalogue served from cache with the network off, across an app restart. Remaining: Demonstrate binary payloads in the demo |
